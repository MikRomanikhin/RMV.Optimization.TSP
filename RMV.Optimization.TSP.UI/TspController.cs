...
{	
	...
	Dictionary<TspAlgorithm, Func<TspAlgorithmBase>> AlgorithmCache => new() {
	...
	public TspAlgorithmBase BuildAlgorithm( TspAlgorithm algorithm )
	{
		...
		return this.Algorithm = AlgorithmCache[ algorithm ]();		
	}
	...
	{		
		...
		{
			form.UpdateStatusLabel( "Operation cancelled by user" );			
		}		
	}
